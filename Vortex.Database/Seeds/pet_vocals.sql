...
-- room chat from the pet. Only types 15 and 35 ship lines; a pet of any other type simply stays
-- quiet rather than being given invented dialogue.
--
-- Re-running is harmless: the delete below scopes to the rows this file owns.
