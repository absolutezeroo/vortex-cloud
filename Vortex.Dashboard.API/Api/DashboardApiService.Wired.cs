...
internal sealed partial class DashboardApiService
{
    ...
    /// <c>wf_xtra_</c> (see <c>Vortex.Rooms/Object/Logic/Furniture/Floor/Wired/**</c>'s
    /// <c>[RoomObjectLogic("wf_...")]</c> attributes), so placed wired furniture is just placed
    /// <see cref="Vortex.Database.Entities.Furniture.FurnitureEntity"/> rows whose definition's Logic
