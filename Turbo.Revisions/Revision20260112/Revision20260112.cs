...
using Turbo.Revisions.Revision20260112.Serializers.Competition;
...
using Turbo.Revisions.Revision20260112.Serializers.Marketplace;
...
public class Revision20260112(IOptions<ProtocolLimitsConfig> protocolLimits) : IRevision
{
    ...
    public IDictionary<int, IParser> Parsers { get; } =
        new Dictionary<int, IParser>
        {
            ...
            { MessageEvent.GetClubGiftInfoRequestMessageEvent, new GetClubGiftInfoMessageParser() },
