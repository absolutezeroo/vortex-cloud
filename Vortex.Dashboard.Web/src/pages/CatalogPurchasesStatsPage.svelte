...
{#if data}
  <div class="metric-grid" style="margin-top: 12px;">
    <article><span>{$t('catalogPurchases.purchaseCount')}</span><strong>{formatNumber(data.totals.purchaseCount)}</strong></article>
    <article><span>{$t('catalogPurchases.totalCreditsSpent')}</span><strong>{formatNumber(data.totals.totalCreditsSpent)}</strong></article>
    <article><span>{$t('catalogPurchases.totalQuantity')}</span><strong>{formatNumber(data.totals.totalQuantity)}</strong></article>
  </div>
