...
{
    Task<(int Result, int OfferId)> MakeOfferAsync(int furnitureItemId, int price, CancellationToken ct);
    ...
    Task<(int CreditsOwed, List<MarketplaceOfferSnapshot> Offers)> GetOwnOffersAsync(CancellationToken ct);
}
