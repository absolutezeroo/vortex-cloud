...
/// claim state machine and the enclosure flood fill. No IO — <see cref="RoomBanzaiSystem"/> turns
/// the returned changes into furni state broadcasts. Tile adjacency is 4-neighbour over the room
