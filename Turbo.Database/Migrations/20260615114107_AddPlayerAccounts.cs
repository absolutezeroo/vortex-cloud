...
namespace Turbo.Database.Migrations
{
    ...
    public partial class AddPlayerAccounts : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "player_accounts");

            migrationBuilder.DropIndex(name: "IX_players_account_id", table: "players");

            migrationBuilder.DropColumn(name: "account_id", table: "players");
        }
    }
}
