...
namespace Turbo.Database.Migrations
{
    ...
    public partial class AddPlayerNavigatorPreferences : Migration
    {
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        player_id = table.Column<int>(type: "int", nullable: false),
                        window_x = table.Column<int>(
                            type: "int",
                            nullable: false,
                            defaultValue: 427
                        ),
                        window_y = table.Column<int>(
                            type: "int",
                            nullable: false,
                            defaultValue: 41
                        ),
                        window_width = table.Column<int>(
                            type: "int",
                            nullable: false,
                            defaultValue: 425
                        ),
                        window_height = table.Column<int>(
                            type: "int",
                            nullable: false,
                            defaultValue: 400
                        ),
                        left_pane_hidden = table.Column<bool>(
                            type: "tinyint(1)",
                            nullable: false,
                            defaultValue: false
                        ),
                        results_mode = table.Column<int>(
                            type: "int",
                            nullable: false,
                            defaultValue: 1
                        ),
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "player_navigator_preferences");
