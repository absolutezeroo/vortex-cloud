...
///
/// Distinct from <see cref="GetNftAssetInventoryMessage"/> despite the near-identical header name
/// they used to share (that one was <c>NftTransferAssets</c>, a permutation of this): that one
