...
namespace Turbo.Authentication.Moderation;
...
/// one of the <see cref="Turbo.Primitives.Permissions.SanctionPresetKind.Ban"/> presets seeded by
/// <see cref="Turbo.Authentication.Permissions.SanctionPresetSeederService"/>, giving
